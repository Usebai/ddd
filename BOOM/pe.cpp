...
ULONG PE::GetExportOffset(const unsigned char* FileData, ULONG FileSize, const char* ExportName)
{
    ...
    {
        Log("[BOOM] Invalid IMAGE_DOS_SIGNATURE!\r\n");
        return PE_ERROR_VALUE;
    }
    ...
    {
        Log("[BOOM] Invalid IMAGE_NT_SIGNATURE!\r\n");
        return PE_ERROR_VALUE;
    }
    ...
    {
        Log("[BOOM] Invalid Export Directory!\r\n");
        return PE_ERROR_VALUE;
    }
    ...
    {
        Log("[BOOM] Invalid Export Directory Contents!\r\n");
        return PE_ERROR_VALUE;
    }
    ...
    {
        Log("[BOOM] Export %s not found in export table!\r\n", ExportName);
    }
